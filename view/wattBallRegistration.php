	...
	<div id='form'>
		...
		<h3>Register for Wattball Tournament</h3>
			<?php
				...
				{
			?>
			<form class="form-horizontal" method='post' name='wattball_registration' action='ajax/registerTeam.php'>
				<div class="control-group">
				  <fieldset>
					...
					<div class="controls">
						<input type="text" placeholder="Type something…" name='teamName' id='teamName'>
						<span class="help-block">This is the Name of the Team that you represent</span>
					</div>
					<label class='control-label'>NWA Number</label>
					<div class="controls">
						<input type="text" placeholder="Type something…" name='nwaNumber' id='nwaNumber'>
				  ...
				  <fieldset>
					...
					<div class="controls">
						<input type="text" placeholder="Type something…" name='contactName' id='contactName'>
						<span class="help-block">Should any problems occur, name someone to be your contact</span>
					</div>
					<label class='control-label'>Contact Number</label>
					<div class="controls">
						<input type="text" placeholder="Type something…" name='contactNumber' id='contactNumber'>
						<span class="help-block">Please Enter Full Number including Area code</span>
					</div>
					<label class='control-label'>Contact Email</label>
					<div class="controls">
						<input type="email" placeholder="Type something…" name='email' id='email'>
						<span class="help-block">Enter a Valid Email we can use to contact you!</span>
					</div>
					<br />
				 </fieldset>
				 <fieldset>
					...
					<div class="controls">
						<textarea rows='11' name='players' id='players'></textarea>
					</div>
				</fieldset>
