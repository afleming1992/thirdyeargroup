...
{
	$save = $app->processHurdleRegistration(htmlspecialchars($_POST['firstname']),htmlspecialchars($_POST['lastname']),htmlspecialchars($_POST['gender']),htmlspecialchars($_POST['dob']),htmlspecialchars($_POST['housenumber']),htmlspecialchars($_POST['streetname']),htmlspecialchars($_POST['city']),htmlspecialchars($_POST['postcode']),htmlspecialchars($_POST['emailcheck']),htmlspecialchars($_POST['emcontact']), htmlspecialchars($_POST['minutes']),htmlspecialchars($_POST['seconds']),htmlspecialchars($_POST['milliseconds']),htmlspecialchars($_POST['tournamentId']));
	if($save)
...
else if(isset($_GET['nextmatches'])){
    $app->loadNextMatchesPage(htmlspecialchars($_GET['nextmatches']));
}
else
	$app->loadHomePage();
