...
--
-- Host: localhost
-- Generation Time: Mar 23, 2013 at 07:13 PM
...
CREATE TABLE IF NOT EXISTS `hurdles_competitors` (
  ...
  `tournamentId` bigint(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `properties` (
  ...
  `ticketsPerTeam` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
...
INSERT INTO `properties` (`id`, `concessionPrice`, `adultPrice`, `ticketLimit`, `ticketsPerTeam`) VALUES
(1, 3, 5, 1000, 25);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3564 ;
